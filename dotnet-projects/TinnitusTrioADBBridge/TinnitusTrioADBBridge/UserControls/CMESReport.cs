...
{
    public partial class CMESReport : DevExpress.XtraReports.UI.XtraReport
    {
        public CMESReport(string patientid, string moduletype, string indate, string outdate, string patientname)
        {
            InitializeComponent();
        ...
        public void GenerateReport(string patientid)
        {
            try
            {
                ...
                var cmtDs = cmtobj.GenerateCmesReport(patientid);
                ...
                rowheader.Cells.Add(headercell);
                headercell= new XRTableCell();
                headercell.Text = "Duration (HH :MM :SS)";
                rowheader.Cells.Add(headercell);

                headercell.Text = "Music File";
                rowheader.Cells.Add(headercell);
        ...
        public void GenerateReport(string patientid, string indate, string outdate)
        {
            try
            {
                ...
                var cmtobj = new TinnitusTrioADB_BAL.ReportGenerator();
                var cmtDs = cmtobj.GeerateCmesDateWiseReport(patientid, indate, outdate);
