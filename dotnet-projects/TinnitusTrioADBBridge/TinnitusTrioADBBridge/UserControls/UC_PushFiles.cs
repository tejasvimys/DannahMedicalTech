    ...
    public partial class UC_PushFiles : UserControl
    {
        ...
        private void UC_PushFiles_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                GetFolderList();
                GetCmesFolderList();
                //as per suhel s request, added a new method to create a new directory for the same.
                CreateDirectory();
            }
        ...
        /// <summary>
        /// new method added to create directory on the fly when the page is loaded.
        /// </summary>
        /// 
