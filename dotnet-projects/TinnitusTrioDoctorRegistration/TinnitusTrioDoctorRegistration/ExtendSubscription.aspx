<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="ExtendSubscription.aspx.cs" Inherits="TinnitusTrioDoctorRegistration.ExtendSubscription" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="row">
        <div class="col-lg-12">
            <h1 class="page-header">Re-Activate Doctor / Extend Subscription
                        </h1>
            <ol class="breadcrumb">
                <li class="active">
                    <i class="fa fa-dashboard"></i><a href="ExtendSubscription.aspx">Re-Activate Doctor / Extend Subscription</a>
                </li>
