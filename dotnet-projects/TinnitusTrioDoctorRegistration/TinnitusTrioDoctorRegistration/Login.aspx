<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="TinnitusTrioDoctorRegistration.Login" %>
    ...
    <form id="form1" runat="server">
     ...
     <div class="form-group log-status1"> 
      ...
      <a class="link" href="#">Lost your password?</a>
         ...
         <asp:Button ID="btnLogin" runat="server" Text="Log in" CausesValidation="true" class="log-btn" OnClick="btnLogin_Click" OnClientClick=""/> 
   </div>
    </form>
</body>
</html>
