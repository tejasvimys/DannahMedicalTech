    ...
    public partial class Form1 : XtraForm
    {
            ...
            if (m.Msg == USBConnectivity.WmDevicechange)
            {
                switch ((int)m.WParam)
                {
                    case USBConnectivity.DbtDeviceremovecomplete:
                        ...
                        statusLblConnectivity.ForeColor = System.Drawing.Color.Blue;
                        statusLblConnectivity.Text = Resources.Form1_WndProc_USB_Disconnected;
                        //var bmp = new Bitmap(TinnitusTrioADBBridge.Properties.Resources.icons_30001);
                        //    pnlDeviceConnectivityStatus.Appearance.Image = bmp;
                        break;
                    case USBConnectivity.DbtDevicearrival:
                        ...
                        statusLblConnectivity.Text = Resources.Form1_WndProc_USB_Device_Connected__Please_CLICK_ON_OK__If_a_pop_up_appears_in_the_android_device_;
                        ...
                        if (retPath == null)
                        {
                            ...
                            statusLblConnectivity.ForeColor = System.Drawing.Color.Red;
                            statusLblConnectivity.Text = Resources.Form1_WndProc_Smart_Phone_Not_Connected_Properly__Please_check_the_device_connectivity_by_plugging_out_and_plugging_in_again__Please_CLICK_ON_OK__If_a_pop_up_appears_in_the_android_device_while_plugged_in_;
                            var bmp1 = new Bitmap(TinnitusTrioADBBridge.Properties.Resources.icons_30001);
                            pnlDeviceConnectivityStatus.Appearance.Image = bmp1;
                        }

                        else
                        {
                            //XtraMessageBox.Show("Smart Phone Connected Properly.");
                            statusLblConnectivity.Text = "Smartphone Connected Successfully";
                            statusLblConnectivity.ForeColor = System.Drawing.Color.Green;
                            var bmp2 = new Bitmap(TinnitusTrioADBBridge.Properties.Resources.icons_30002);
                            pnlDeviceConnectivityStatus.Appearance.Image = bmp2;
                        }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                //getting the patient license code
                var objPatientCode = new TinnitusTrioADB_BAL.LicenseManager();
                var lblPatientCode = objPatientCode.GetAppLicenseId(lblPatientID.Text.Trim());
                lblAppRegId.Text = lblPatientCode;
            }
            catch (Exception exception)
            {
                //WaitForm.CloseForm();
        ...
        private void DeActivatePatient_Clicked(object sender, DevExpress.XtraNavBar.NavBarLinkEventArgs e)
        {
            try
            {
                ...
                //var objBALdoctor = new TinnitusTrioADB_BAL.LicenseManager();
                //var doctorcode = objBALdoctor.getDoctorCode();
                var ucpushfiles = new OfflineKeyGenerator(lblPatientID.Text.Trim());
                pnlMain.Controls.Clear();
                ucpushfiles.Dock = DockStyle.Fill;
                pnlMain.Controls.Add(ucpushfiles);
            }
        ...
        private void renewLicense_LinkClicked(object sender, DevExpress.XtraNavBar.NavBarLinkEventArgs e)
        {
             try
            {
                var objBALdoctor = new TinnitusTrioADB_BAL.LicenseManager();
                ...
                var ucpushfiles = new UC_RenewLicense(doctorcode);
                pnlMain.Controls.Clear();
                ucpushfiles.Dock = DockStyle.Fill;
                pnlMain.Controls.Add(ucpushfiles);
            }
