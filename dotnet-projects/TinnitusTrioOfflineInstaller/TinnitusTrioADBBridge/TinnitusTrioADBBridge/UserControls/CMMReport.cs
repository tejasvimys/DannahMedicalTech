...
{
    public partial class CMMReport : DevExpress.XtraReports.UI.XtraReport
    {
        public CMMReport(string patientid, string moduletype, string indate, string outdate, string patientname)
        {
            InitializeComponent();
        ...
        public void GenerateReport(string patientid)
        {
            try
            {
                ...
                var cmtDs = cmtobj.GenerateCmmReport(patientid);
        ...
        public void GenerateReport(string patientid, string indate, string outdate)
        {
            try
            {
                ...
                var cmtobj = new TinnitusTrioADB_BAL.ReportGenerator();
                var cmtDs = cmtobj.GeerateCmmDateWiseReport(patientid, indate, outdate);
