 ...
 */
public class AudioGeneratorLeft {

    private int sampleRate;
    private AudioTrack audioTrack;

    public AudioGeneratorLeft(int sampleRate) {
    ...
    public double[] getSineWave(int samples,int sampleRate,double frequencyOfTone){
       ...
       // for (int i = 0; i < samples; i++) {
         //  sample[i+0] = Math.sin(2 * Math.PI * i / (sampleRate/frequencyOfTone));
         //   sample[i+1]=0;
        // }
    ...
    public void createPlayer(){
        ...
        audioTrack.setStereoVolume(100, 0);
        audioTrack.play();
    }
