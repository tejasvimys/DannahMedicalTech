...
public class GetService {
    ...
    public boolean InsertUserDetails(String UserId, String MacID, String SerialNo, String UniqueId){
        ...
        try {
            ...
            boolean responsvalue = responseobject.getBoolean("insertpatientResult");
    ...
    public String InsertLogDetails(JSONArray JsonValue){
        ...
        try {
            ...
            HttpPost request = new HttpPost("http://tinnitustrioservice-dev.elasticbeanstalk.com/Service1.svc/synccmesdata");
            request.setHeader("Accept", "application/json");
            request.setHeader("Content-type", "application/json, charset=utf-8");

            // StringEntity entity = new StringEntity(JsonValue.toString(), HTTP.UTF_8);
            //entity.setContentType("application/xml");
            //request.setHeader("Content-Type", "application/xml;charset=UTF-8");

            JSONStringer userIDS = new JSONStringer()
                    .object()
                    .key("xmlfile").value((JsonValue))
