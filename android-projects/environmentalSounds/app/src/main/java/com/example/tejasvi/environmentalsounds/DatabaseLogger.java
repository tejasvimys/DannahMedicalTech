...
public class DatabaseLogger extends SQLiteOpenHelper {
    ...
    private static final String TABLE_LOGGER = "CMESLogger";
    ...
    public void onCreate(SQLiteDatabase db) {
        String CREATE_CONTACTS_TABLE = "CREATE TABLE " + TABLE_LOGGER + "("
                ...
                + KEY_DURATION + " TEXT," + KEY_ISACTIVE+" TEXT," + KEY_ISSYNC + " TEXT," + KEY_TRACK+ " TEXT" +")";
    ...
    public void addPatient(sqlitesync patient) {
        ...
        values.put(KEY_TRACK,patient.get_Track());
