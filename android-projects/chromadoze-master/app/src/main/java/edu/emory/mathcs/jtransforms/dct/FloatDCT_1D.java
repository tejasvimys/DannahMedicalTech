...
*/
    ...
    public FloatDCT_1D(int n) {
        Log.i("main", "Inside Constructor of FloatDct_1D");
        if (n < 1) {
...
*/
    ...
    public void inverse(float[] a, boolean scale) {
        Log.i("main", "Inside inverse of FloatDct_1D");
...
*/
    ...
    private void makewt(int nw) {
        Log.i("main", "Inside makewt of FloatDct_1D");
    ...
    private void makeipt(int nw) {
        ...
        Log.i("main", "Inside makeipt of FloatDct_1D");
    ...
    private void makect(int nc, float[] c, int startc) {
        Log.i("main", "Inside makect of FloatDct_1D");
    ...
    private void cftfsub(int n, float[] a, int offa, int[] ip, int nw, float[] w) {
        Log.i("main", "Inside cftfsub of FloatDct_1D");
...
*/
    ...
    private void bitrv2(int n, int[] ip, float[] a, int offa) {
        Log.i("main", "Inside bitrv2 of FloatDct_1D");
...
*/
    ...
    private void bitrv216(float[] a, int offa) {
        Log.i("main", "Inside bitrv216 of FloatDct_1D");
...
*/
    ...
    private void bitrv208(float[] a, int offa) {
        Log.i("main", "Inside bitrv208 of FloatDct_1D");
...
*/
    ...
    private void cftf1st(int n, float[] a, int offa, float[] w, int startw) {
        Log.i("main", "Inside cftflst of FloatDct_1D");
...
*/
    ...
    private void cftrec4_th(final int n, final float[] a, final int offa, final int nw, final float[] w) {
        Log.i("main", "Inside cftrec4_th of FloatDct_1D");
    ...
    private void cftrec4(int n, float[] a, int offa, int nw, float[] w) {
        Log.i("main", "Inside cftrec4 of FloatDct_1D");
    ...
    private int cfttree(int n, int j, int k, float[] a, int offa, int nw, float[] w) {
        int i, isplt, m;
        Log.i("main", "Inside cfttree of FloatDct_1D");
    ...
    private void cftleaf(int n, int isplt, float[] a, int offa, int nw, float[] w) {
        Log.i("main", "Inside cftleaf of FloatDct_1D");
    ...
    private void cftmdl1(int n, float[] a, int offa, float[] w, int startw) {
        Log.i("main", "Inside cftmdl1 of FloatDct_1D");
        int j0, j1, j2, j3, k, m, mh;
    ...
    private void cftmdl2(int n, float[] a, int offa, float[] w, int startw) {
        Log.i("main", "Inside cftmdl2 of FloatDct_1D");
    ...
    private void cftfx41(int n, float[] a, int offa, int nw, float[] w) {
        Log.i("main", "Inside cftfx41 of FloatDct_1D");
    ...
    private void cftf161(float[] a, int offa, float[] w, int startw) {
        ...
        Log.i("main", "Inside cftf161 of FloatDct_1D");
    ...
    private void cftf162(float[] a, int offa, float[] w, int startw) {
        Log.i("main", "Inside cftf162 of FloatDct_1D");
    ...
    private void cftf081(float[] a, int offa, float[] w, int startw) {
        ...
        Log.i("main", "Inside cftf081 of FloatDct_1D");
    ...
    private void cftf082(float[] a, int offa, float[] w, int startw) {
        ...
        Log.i("main", "Inside cftf082 of FloatDct_1D");
    ...
    private void cftf040(float[] a, int offa) {
        float x0r, x0i, x1r, x1i, x2r, x2i, x3r, x3i;
        Log.i("main", "Inside cftf040 of FloatDct_1D");
...
*/
    ...
    private void cftx020(float[] a, int offa) {
        float x0r, x0i;
        Log.i("main", "Inside cftx020 of FloatDct_1D");
    ...
    private void rftfsub(int n, float[] a, int offa, int nc, float[] c, int startc) {
        int k, kk, ks, m;
        Log.i("main", "Inside rftfsub of FloatDct_1D");
...
*/
    ...
    private void dctsub(int n, float[] a, int offa, int nc, float[] c, int startc) {
        int k, kk, ks, m;
        Log.i("main", "Inside dctsub of FloatDct_1D");
    ...
    private void scale(final float m, final float[] a, final int offa) {
        Log.i("main", "Inside scale of FloatDct_1D");
