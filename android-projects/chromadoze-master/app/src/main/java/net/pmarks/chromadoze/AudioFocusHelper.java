...
class AudioFocusHelper implements OnAudioFocusChangeListener {
    ...
    public AudioFocusHelper(Context ctx, SampleShuffler.VolumeListener volumeListener) {
        Log.i("main", "Inside parameterize Constructor of AudioFocusHelper");
        mContext = ctx;
    ...
    public void setActive(boolean active) {
        Log.i("main", "Inside setActive of AudioFragment");
        if (mActive == active) {
            return;
        }
        if (active) {
    ...
    private void requestFocus() {
        ...
        Log.i("main", "Inside requestFocus of AudioFragment");
    ...
    public void onAudioFocusChange(int focusChange) {
        ...
        Log.i("main", "Inside onAudioFocus of AudioFragment");
        switch (focusChange) {
