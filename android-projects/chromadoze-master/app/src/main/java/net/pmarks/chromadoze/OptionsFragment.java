...
public class OptionsFragment extends Fragment implements OnSeekBarChangeListener, OnCheckedChangeListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.i("main", "Inside OncreateView of OptionFragment");
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        Log.i("main", "Inside OnActivityCreated of OptionFragment");
    ...
    public void onResume() {
        Log.i("main", "Inside OnResume of OptionFragment");
        super.onResume();
    ...
    public void onProgressChanged(SeekBar seekBar, int progress,
                                  boolean fromUser) {
        Log.i("main", "Inside OnProgressChanged of OptionFragment");
        if (!fromUser) {
            return;
        }
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        Log.i("main", "Inside OnCheckedChange of OptionFragment");
    ...
    public void onStartTrackingTouch(SeekBar seekBar) {
        Log.i("main", "Inside onStartTrackingTouch of OptionFragment");
    }

    @Override
    public void onStopTrackingTouch(SeekBar seekBar) {
        Log.i("main", "Inside OnStopTrackingTouch of OptionFragment");
    }

    private void redrawVolumeLimit() {
        Log.i("main", "Inside redrawVolumeLimit of OptionFragment");
