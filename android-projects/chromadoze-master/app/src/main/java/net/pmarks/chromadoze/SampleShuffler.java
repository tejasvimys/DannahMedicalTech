...
class SampleShuffler {
    ...
    static {
        Log.i("main", "Inside staticBlock of SampleSuffler");
    ...
    public SampleShuffler(AudioParams params) {
        Log.i("main", "Inside constructor of SampleSuffler");
        mParams = params;

        // Start playing silence until real data arrives.
        mGlobalVolumeFactor = 0;
        Log.i("main", "before exchangeChunk of constructor of SampleSuffler");
        exchangeChunk(withPcm(new AudioChunk(new float[FADE_LEN * 2])), true);
        Log.i("main", "before playBackThread of constructor of SampleSuffler");
        mPlaybackThread = new PlaybackThread();
        mPlaybackThread.start();
    }

    public void stopThread() {
        Log.i("main", "Inside stopThread of SampleSuffler");
    ...
    public VolumeListener getVolumeListener() {
        ...
        Log.i("main", "Inside VolumeListener of SampleSuffler");
        return mPlaybackThread;
    }

    public synchronized void setAmpWave(float minVol, float period) {
        Log.i("main", "Inside setAmpWave of SampleSuffler");
    ...
    private static class ShuffleBag {
        ...
        public void clear() {
            Log.i("main", "Inside clear of ShuffleBag of SampleSuffler");
            newQueue.clear();
            feederQueue.clear();
            drawPile.clear();
            discardPile.clear();
        ...
        public void put(int x, boolean neverPlayed) {
            ...
            Log.i("main", "Inside put of ShuffleBag of SampleSuffler");
            (neverPlayed ? newQueue : drawPile).add(x);
        }

        public int getNext() {
            Log.i("main", "Inside getNext of ShuffleBag of SampleSuffler");
            if (!newQueue.isEmpty()) {
        ...
        private static int pop(List<Integer> list) {
            ...
            Log.i("main", "Inside pop of ShuffleBag of SampleSuffler");
    ...
    private static class AudioChunk {
        ...
        public AudioChunk(float[] floatData) {
            Log.i("main", "Inside constructor of AudioChunk of SampleSuffler");
        ...
        private void computeMaxAmplitude() {
            Log.i("main", "Inside computeMaxAmplitude of ShuffleBag of SampleSuffler");
        ...
        public float getMaxAmplitude() {
            ...
            Log.i("main", "Inside getMaxAmptitude of ShuffleBag of SampleSuffler");
            return mMaxAmplitude;
        }

        public void buildPcmData(float volumeFactor) {
            Log.i("main", "Inside buildPcmData of ShuffleBag of SampleSuffler");
        ...
        public boolean neverPlayed() {
            Log.i("main", "Inside neverPlayed of ShuffleBag of SampleSuffler");
            return mNeverPlayed;
        }

        public short[] getPcmData() {
            Log.i("main", "Inside getPcmData of ShuffleBag of SampleSuffler");
            mNeverPlayed = false;
            return mPcmData;
        }
        ...
        public void purgeFloatData() {
            ...
            Log.i("main", "Inside purgeFloatData of ShuffleBag of SampleSuffler");
            mFloatData = null;
        }
    }

    public boolean handleChunk(float[] dctData, int stage) {
        Log.i("main", "Inside handleChunk of ShuffleBag of SampleSuffler");
    ...
    private void handleChunkPioneer(AudioChunk newChunk, boolean notify) {
        Log.i("main", "Inside handleChunkPioneer of ShuffleBag of SampleSuffler");
    ...
    private void handleChunkAdaptVolume(AudioChunk newChunk) {
        Log.i("main", "Inside handleChunkAdaptVolume of ShuffleBag of SampleSuffler");
    ...
    private void handleChunkFinalizeVolume(AudioChunk newChunk) {
        Log.i("main", "Inside handleChunkFinalizeVolume of ShuffleBag of SampleSuffler");
    ...
    private boolean handleChunkNoClip(AudioChunk newChunk) {
        Log.i("main", "Inside handleChunkNoClip of ShuffleBag of SampleSuffler");
        if (newChunk.getMaxAmplitude() * mGlobalVolumeFactor > CLIP_AMPLITUDE) {
            return false;
        } else {
            addChunk(withPcm(newChunk));
    ...
    private void changeGlobalVolume(float maxAmplitude, AudioChunk newChunk) {
        Log.i("main", "Inside changeGlobalVolume of ShuffleBag of SampleSuffler");
    ...
    private AudioChunk withPcm(AudioChunk chunk) {
        Log.i("main", "Inside withPcm of ShuffleBag of SampleSuffler");
        chunk.buildPcmData(mGlobalVolumeFactor);
        return chunk;
    }

    private synchronized void resetFillState(short chunk0[]) {
        Log.i("main", "Inside resetFillState of ShuffleBag of SampleSuffler");
    ...
    private synchronized short[] getRandomChunk() {
        Log.i("main", "Inside getRandomChunk of ShuffleBag of SampleSuffler");
        return mAudioChunks.get(mShuffleBag.getNext()).getPcmData();
    }

    private synchronized void addChunk(AudioChunk chunk) {
        Log.i("main", "Inside addChunk of ShuffleBag of SampleSuffler");
    ...
    private synchronized List<AudioChunk> exchangeChunk(AudioChunk chunk, boolean notify) {
        Log.i("main", "Inside exchangeChunk of ShuffleBag of SampleSuffler");
        if (notify) {
            if (mAudioChunks != null && mAlternateFuture == null) {
                Log.i("main", "Inside if of exchangeChunk of ShuffleBag of SampleSuffler");
    ...
    private synchronized AmpWave fillBuffer(short[] out) {
        Log.i("main", "Inside fillBuffer of ShuffleBag of SampleSuffler");
        if (mChunk0 == null) {
    ...
    private class AmpWave {
        ...
        public AmpWave(float minVol, float period) {
            Log.i("main", "Inside constructor of AmpWave of SampleSuffler");
            if (minVol > .999f || period < .001f) {
                Log.i("main", "Inside first if of AmpWave of SampleSuffler");
                mTweakedSine = null;
                mSpeed = 0;
            } else {
                Log.i("main", "Inside else of AmpWave of SampleSuffler");
                ...
                Log.i("main", "outside of else of AmpWave of SampleSuffler");
                mSpeed = (int) (SINE_PERIOD / (period * mParams.SAMPLE_RATE));
            }
            Log.i("main", "outside of first if of AmpWave of SampleSuffler");
            mMinVol = minVol;
            mPeriod = period;
        }
        ...
        public void copyOldPosition(AmpWave old) {
            Log.i("main", "Inside copyOldPosition of AmpWave of SampleSuffler");
        ...
        public void mutateBuffer(short buf[]) {
            Log.i("main", "Inside mutateBuffer of AmpWave of SampleSuffler");
    ...
    private class PlaybackThread extends Thread implements VolumeListener {
        ...
        PlaybackThread() {
            ...
            Log.i("main", "Inside constructor of PlayBackThread of SampleSuffler");
        }
        ...
        private synchronized boolean startPlaying() {
            Log.i("main", "Inside startPlaying of PlayBackThread of SampleSuffler");
        ...
        public synchronized void stopPlaying() {
            Log.i("main", "Inside stopPlaying of PlayBackThread of SampleSuffler");
            if (mTrack == null) {
                mPreventStart = true;
            } else {
                mTrack.stop();
        ...
        public synchronized void setDuckLevel(DuckLevel d) {
            Log.i("main", "Inside setDuckLevel of PlayBackThread of SampleSuffler");
            mDuckLevel = d;
            if (mTrack != null) {
                setVolumeInternal();
            }
        ...
        public synchronized void setVolumeLevel(float v) {
            Log.i("main", "Inside setVolumeLevel of PlayBackThread of SampleSuffler");
            if (v < 0f || v > 1f) {
        ...
        private void setVolumeInternal() {
            Log.i("main", "Inside setVolumeInternal of PlayBackThread of SampleSuffler");
            float v;
            switch (mDuckLevel) {
                case SILENT:
                    v = 0f;
        ...
        @Override
        public void run() {
            Log.i("main", "Inside run of PlayBackThread of SampleSuffler");
