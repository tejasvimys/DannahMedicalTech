...
class SampleGeneratorState {
    ...
    public void reset() {
        Log.i("main", "Inside reset of SampleGenaratorState");
        mChunkNumber = 0;
    }

    public void advance()
    {        Log.i("main", "Inside advance of SampleGenaratorState");
        mChunkNumber++;
    }

    public boolean done() {

        Log.i("main", "Inside done of SampleGenaratorState");
        return mChunkNumber >= N_TOTAL_CHUNKS;
    }

    public int getStage() {
        Log.i("main", "Inside getStage of SampleGenaratorState");
    ...
    public int getPercent() {
        Log.i("main", "Inside getPercent of SampleGenaratorState");
        return mChunkNumber * 100 / N_TOTAL_CHUNKS;
    }

    public int getChunkSize() {
        Log.i("main", "Inside getChunkSize of SampleGenaratorState");
