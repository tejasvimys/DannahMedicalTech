...
public class MemoryArrayAdapter extends ArrayAdapter<Phonon> {
    ...
    public MemoryArrayAdapter(Context context, List<Phonon> objects) {
        ...
        Log.i("main", "Inside Constructor of MemoryArrayAdapter");
    }

    @Override
    public View getView(int position, View convertView, ViewGroup parent) {
        Log.i("main", "Inside getView of MemoryArrayAdapter");
    ...
    public void initListItem(View view, Phonon ph, Saved saved) {
        ...
        Log.i("main", "Inside initListItem of MemoryArrayAdapter");
        if (ph.getMinVol() != 100) {
