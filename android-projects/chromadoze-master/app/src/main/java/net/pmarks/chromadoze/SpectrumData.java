...
public class SpectrumData implements Parcelable {
    public static final Parcelable.Creator<SpectrumData> CREATOR
        ...
        {
            Log.i("main", "Inside createFromParcel of SpectrumData");
        ...
        public SpectrumData[] newArray(int size) {
            ...
            Log.i("main", "Inside newArraySize of SpectrumData");
    ...
    private static int[] calculateEdgeFreqs() {
        Log.i("main", "Inside calculateEdgefreqs of SpectrumData");
    ...
    public SpectrumData(float[] donateBars) {
        Log.i("main", "Inside constructor(float) of SpectrumData");
    ...
    private SpectrumData(Parcel in) {
        Log.i("main", "Inside constructor(parcel) of SpectrumData");
    ...
    {
        Log.i("main", "Inside describeContents of SpectrumData");
        return 0;
    }

    @Override
    public void writeToParcel(Parcel dest, int flags) {
        Log.i("main", "Inside writeToParcel of SpectrumData");
        dest.writeFloatArray(mData);
    }

    public void fill(float[] out, int sampleRate) {
        Log.i("main", "Inside fill of SpectrumData");
    ...
    private void subFill(float[] out, float setValue, int startFreq, int limitFreq, int maxFreq) {
        ...
        Log.i("main", "Inside subfill of SpectrumData");
    ...
    public boolean sameSpectrum(SpectrumData other) {
        Log.i("main", "Inside sameSpectrum of SpectrumData");
        if (other == null) {
            return false;
        }
        for (int i = 0; i < BAND_COUNT; i++) {
