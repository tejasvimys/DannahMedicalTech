...
public class NoiseService extends Service {
    ...
    private static class PercentHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            Log.i("main", "Inside handleMassage of PercentHandler of NoiseService");
    ...
    public void onCreate() {
        Log.i("main", "Inside onCreate of PercentHandler of NoiseService");
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Log.i("main", "Inside onStartCommand of PercentHandler of NoiseService");
    ...
    public void onDestroy() {
        ...
        Log.i("main", "Inside onDestroy of PercentHandler of NoiseService");
    ...
    public IBinder onBind(Intent intent) {
        // Don't use binding.
        Log.i("main", "Inside onBind of PercentHandler of NoiseService");
        return null;
    }
    ...
    private Notification makeNotify() {
        ...
        Log.i("main", "Inside makeNotify of PercentHandler of NoiseService");
    ...
    private void addButtonToNotification(Notification n) {
        ...
        Log.i("main", "Inside addButtonNotification of PercentHandler of NoiseService");
    ...
    private static TextView findTextView(View view, String title) {
        Log.i("main", "Inside findTextView of PercentHandler of NoiseService");
    ...
    public void updatePercentAsync(int percent) {
        Log.i("main", "Inside updatePercentAsync of PercentHandler of NoiseService");
        mPercentHandler.removeMessages(PERCENT_MSG);
    ...
    private static void updatePercent(int percent) {
        Log.i("main", "Inside updatePercent of PercentHandler of NoiseService");
    ...
    public static void addPercentListener(PercentListener listener) {
        ...
        Log.i("main", "Inside addPercentListener of PercentHandler of NoiseService");
    ...
    public static void removePercentListener(PercentListener listener) {
        Log.i("main", "Inside removePercentListener of PercentHandler of NoiseService");
    ...
    public static void sendStopIntent(Context ctx) {
        Log.i("main", "Inside sendStopIntent of PercentHandler of NoiseService");
