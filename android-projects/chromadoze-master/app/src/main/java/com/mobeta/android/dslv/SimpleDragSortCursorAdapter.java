...
public class SimpleDragSortCursorAdapter extends ResourceDragSortCursorAdapter {
    ...
    public SimpleDragSortCursorAdapter(Context context, int layout, Cursor c,
        ...
        Log.i("main", "Inside Constructor of SimpleDragSortCursorAdapter");
    ...
    public SimpleDragSortCursorAdapter(Context context, int layout, Cursor c,
        ...
        Log.i("main", "Inside Constructor 2 of SimpleDragSortCursorAdapter");
        mTo = to;
        mOriginalFrom = from;
        findColumns(c, from);
    }
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        Log.i("main", "Inside bindView of SimpleDragSortCursorAdapter");
    ...
    public ViewBinder getViewBinder() {
        Log.i("main", "Inside getViewBinder of SimpleDragSortCursorAdapter");
        return mViewBinder;
    }
    ...
    public void setViewBinder(ViewBinder viewBinder) {
        Log.i("main", "Inside setViewBinder of SimpleDragSortCursorAdapter");
    ...
    public void setViewImage(ImageView v, String value) {
        Log.i("main", "Inside setVIewImage of SimpleDragSortCursorAdapter");
        try {
    ...
    public void setViewText(TextView v, String text) {
        Log.i("main", "Inside setViewText of SimpleDragSortCursorAdapter");
        v.setText(text);
    }
    ...
    public int getStringConversionColumn() {
        Log.i("main", "Inside getStringConversionColumn of SimpleDragSortCursorAdapter");
    ...
    public void setStringConversionColumn(int stringConversionColumn) {
        Log.i("main", "Inside setStringConversionColumn of SimpleDragSortCursorAdapter");
    ...
    {        Log.i("main", "Inside cursorToStringConverter of SimpleDragSortCursorAdapter");
    ...
    public void setCursorToStringConverter(
        ...
        Log.i("main", "Inside setCursorToStringConvert of SimpleDragSortCursorAdapter");
    ...
    public CharSequence convertToString(Cursor cursor) {
        Log.i("main", "Inside charSequence of SimpleDragSortCursorAdapter");
    ...
    private void findColumns(Cursor c, String[] from) {
        Log.i("main", "Inside findColumns of SimpleDragSortCursorAdapter");
        if (c != null) {
            int i;
    ...
    public Cursor swapCursor(Cursor c) {
        ...
        Log.i("main", "Inside swapCursor of SimpleDragSortCursorAdapter");
    ...
    public void changeCursorAndColumns(Cursor c, String[] from, int[] to) {
        Log.i("main", "Inside changeCursorAndColumns of SimpleDragSortCursorAdapter");
        mOriginalFrom = from;
        mTo = to;
