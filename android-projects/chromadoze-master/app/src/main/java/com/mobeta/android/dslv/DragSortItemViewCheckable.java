...
public class DragSortItemViewCheckable extends DragSortItemView implements
    ...
    public DragSortItemViewCheckable(Context context) {
        super(context);
        Log.i("main", "Inside constructor of DragSortItemViewCheckable");

    }

    @Override
    public boolean isChecked() {
        Log.i("main", "Inside isChecked of DragSortItemViewCheckable");
    ...
    public void setChecked(boolean checked) {
        Log.i("main", "Inside setChecked of DragSortItemViewCheckable");
        View child = getChildAt(0);
        if (child instanceof Checkable)
    ...
    @Override
    public void toggle() {
        Log.i("main", "Inside toggle of DragSortItemViewCheckable");
        View child = getChildAt(0);
        if (child instanceof Checkable)
