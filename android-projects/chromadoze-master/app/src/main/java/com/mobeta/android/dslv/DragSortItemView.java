...
public class DragSortItemView extends ViewGroup {
    ...
    public DragSortItemView(Context context) {
        super(context);
        Log.i("main", "Inside constructor of DragSortItemView");
    ...
    public void setGravity(int gravity) {
        Log.i("main", "Inside setGravity of DragSortItemView");

        mGravity = gravity;
    }

    public int getGravity() {
        Log.i("main", "Inside getGravity of DragSortItemView");
    ...
    protected void onLayout(boolean changed, int left, int top, int right,
            int bottom) {
        Log.i("main", "Inside onLayout of DragSortItemView");
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        Log.i("main", "Inside onMesure of DragSortItemView");
