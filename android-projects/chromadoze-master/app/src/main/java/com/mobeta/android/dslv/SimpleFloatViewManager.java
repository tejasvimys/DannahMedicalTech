...
public class SimpleFloatViewManager implements
    ...
    public SimpleFloatViewManager(ListView lv) {
        ...
        Log.i("main", "Inside Constructor of SimpleFloatViewManager");
        mListView = lv;
    }

    public void setBackgroundColor(int color) {

        Log.i("main", "Inside setBackGroundColor of SimpleFloatViewManager");
        mFloatBGColor = color;
    }
    ...
    public View onCreateFloatView(int position) {
        ...
        Log.i("main", "Inside onCreateFloatView of SimpleFloatViewManager");
    ...
    public void onDragFloatView(View floatView, Point position, Point touch) {
        // do nothing
        Log.i("main", "Inside onDragFloatView of SimpleFloatViewManager");
    }
    ...
    public void onDestroyFloatView(View floatView) {
        Log.i("main", "Inside onDestroyFloatView of SimpleFloatViewManager");
