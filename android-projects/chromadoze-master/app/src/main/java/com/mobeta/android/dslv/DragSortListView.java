...
public class DragSortListView extends ListView {
    ...
    public DragSortListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        Log.i("main", "Inside constructor of DragSortListView");
        ...
        mObserver = new DataSetObserver() {
            ...
            public void onChanged() {
                ...
                Log.i("main", "Inside onChanged of DragSortListView");
                cancel();
            }
            ...
            public void onInvalidated() {
                ...
                Log.i("main", "Inside onInvalidate of DragSortListView");
                cancel();
            }
        };
    }
    ...
    public void setFloatAlpha(float alpha) {
        ...
        Log.i("main", "Inside setFloatAlpha of DragSortListView");
        mCurrFloatAlpha = alpha;
    }

    public float getFloatAlpha()
    {
        Log.i("main", "Inside getFloatAlpha of DragSortListView");
    ...
    public void setMaxScrollSpeed(float max) {
        Log.i("main", "Inside setMaxScrollSpeed of DragSortListView");
        mMaxScrollSpeed = max;
    }
    ...
    public void setAdapter(ListAdapter adapter) {
        Log.i("main", "Inside setAdapter of DragSortListView");
        if (adapter != null) {
    ...
    public ListAdapter getInputAdapter() {
        Log.i("main", "Inside getInputAdapter of DragSortListView");
    ...
    private class AdapterWrapper extends BaseAdapter {
        ...
        public AdapterWrapper(ListAdapter adapter) {
            super();
            Log.i("main", "Inside constructor of AdapterWraper of DragSortListView");
            mAdapter = adapter;
        ...
        public ListAdapter getAdapter() {
            Log.i("main", "Inside getAdapter of AdapterWraper of DragSortListView");
            return mAdapter;
        }
        ...
        {
            Log.i("main", "Inside getItemId of AdapterWraper of DragSortListView");
            return mAdapter.getItemId(position);
        }

        @Override
        public Object getItem(int position) {
            Log.i("main", "Inside getItem of AdapterWraper of DragSortListView");
        ...
        public int getCount() {
            ...
            Log.i("main", "Inside getCount of AdapterWraper of DragSortListView");
        ...
        public boolean areAllItemsEnabled() {
            ...
            Log.i("main", "Inside areAllItemsEnabled of AdapterWraper of DragSortListView");
        ...
        public boolean isEnabled(int position) {
            ...
            Log.i("main", "Inside isEnabled of AdapterWraper of DragSortListView");
        ...
        public int getItemViewType(int position) {
            ...
            Log.i("main", "Inside getItemView of AdapterWraper of DragSortListView");
        ...
        public int getViewTypeCount() {
            ...
            Log.i("main", "Inside getViewTypeCount of AdapterWraper of DragSortListView");
        ...
        public boolean hasStableIds() {
            ...
            Log.i("main", "Inside hasStableIds of AdapterWraper of DragSortListView");
        ...
        public boolean isEmpty() {
            ...
            Log.i("main", "Inside isEmpty of AdapterWraper of DragSortListView");
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            Log.i("main", "Inside getView of AdapterWraper of DragSortListView");
            DragSortItemView v;
            View child;
            // Log.d("mobeta",
    ...
    private void drawDivider(int expPosition, Canvas canvas) {
        ...
        Log.i("main", "Inside drawDevider of AdapterWraper of DragSortListView");
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        Log.i("main", "Inside dispatchDraw of AdapterWraper of DragSortListView");
        if (mDragState != IDLE) {
    ...
    private int getItemHeight(int position) {
        Log.i("main", "Inside getItemHeight of AdapterWraper of DragSortListView");
    ...
    private void printPosData() {
        Log.i("main", "Inside printPosData of AdapterWraper of DragSortListView");
    ...
    private class HeightCache {
        ...
        public HeightCache(int size) {
            Log.i("main", "Inside constructor of HeightCache of DragSortListView");
        ...
        public void add(int position, int height) {
            Log.i("main", "Inside add of HeightCache of DragSortListView");
        ...
        {
            Log.i("main", "Inside get of HeightCache of DragSortListView");
            return mMap.get(position, -1);
        }

        public void clear() {
            Log.i("main", "Inside clear of HeightCache of DragSortListView");
            mMap.clear();
            mOrder.clear();
        }
    ...
    private int getShuffleEdge(int position, int top) {
        Log.i("main", "Inside getShuffelEdge of HeightCache of DragSortListView");
    ...
    private boolean updatePositions() {
        Log.i("main", "Inside updatePositions of HeightCache of DragSortListView");
    ...
    protected void onDraw(Canvas canvas) {
        super.onDraw(canvas);
        Log.i("main", "Inside onDraw of HeightCache of DragSortListView");
        if (mTrackDragSort) {
    ...
    private class SmoothAnimator implements Runnable {
        ...
        public SmoothAnimator(float smoothness, int duration) {
            Log.i("main", "Inside constructor of SmoothAnimator of DragSortListView");
            mAlpha = smoothness;
            mDurationF = duration;
        ...
        public float transform(float frac) {
            Log.i("main", "Inside transform of SmoothAnimator of DragSortListView");
            if (frac < mAlpha) {
                return mA * frac * frac;
        ...
        public void start() {
            Log.i("main", "Inside start of SmoothAnimator of DragSortListView");
        ...
        public void cancel() {
            ...
            Log.i("main", "Inside cancel of SmoothAnimator of DragSortListView");
            mCanceled = true;
        }

        public void onStart() {
            Log.i("main", "Inside onStart of SmoothAnimator of DragSortListView");
            // stub
        }

        public void onUpdate(float frac, float smoothFrac) {
            // stub
            Log.i("main", "Inside onUpdate of SmoothAnimator of DragSortListView");
        }

        public void onStop() {
            // stub
            Log.i("main", "Inside onStop of SmoothAnimator of DragSortListView");
        }

        @Override
        public void run() {
            Log.i("main", "Inside run of SmoothAnimator of DragSortListView");
            if (mCanceled) {
                return;
            }
    ...
    private class LiftAnimator extends SmoothAnimator {
        ...
        public LiftAnimator(float smoothness, int duration) {
            ...
            Log.i("main", "Inside constructor of LiftAnimATOR of DragSortListView");

        }

        @Override
        public void onStart() {
            Log.i("main", "Inside ONsTART of LiftAnimATOR of DragSortListView");
        ...
        public void onUpdate(float frac, float smoothFrac) {
            ...
            Log.i("main", "Inside onUpdate of LiftAnimATOR of DragSortListView");
            if (mDragState != DRAGGING) {
                cancel();
            } else {
    ...
    private class DropAnimator extends SmoothAnimator {
        ...
        public DropAnimator(float smoothness, int duration) {
            super(smoothness, duration);
            Log.i("main", "Inside constructor of DropAnimator of DragSortListView");

        }

        @Override
        public void onStart() {
            Log.i("main", "Inside onStart of DropAnimator of DragSortListView");
            mDropPos = mFloatPos;
            srcPos = mSrcPos;
            mDragState = DROPPING;
        ...
        private int getTargetY() {
            Log.i("main", "Inside getTargetY of DropAnimator of DragSortListView");
            final int first = getFirstVisiblePosition();
        ...
        @Override
        public void onUpdate(float frac, float smoothFrac) {
            Log.i("main", "Inside onUpdate of DropAnimator of DragSortListView");
        ...
        public void onStop() {
            ...
            Log.i("main", "Inside onStop of DropAnimator of DragSortListView");
            dropFloatView();
        }
    ...
    private class RemoveAnimator extends SmoothAnimator {
        ...
        public RemoveAnimator(float smoothness, int duration) {
            super(smoothness, duration);
            Log.i("main", "Inside Constructor of RemoveAnimator of DragSortListView");
        }

        @Override
        public void onStart() {
            Log.i("main", "Inside onStart of RemoveAnimator of DragSortListView");
            mFirstChildHeight = -1;
        ...
        @Override
        public void onUpdate(float frac, float smoothFrac) {
            Log.i("main", "Inside onUpdate of RemoveAnimator of DragSortListView");
        ...
        @Override
        public void onStop() {
            Log.i("main", "Inside onStop of RemoveAnimator of DragSortListView");
            doRemoveItem();
        }
    }

    public void removeItem(int which) {
        Log.i("main", "Inside removeItem of RemoveAnimator of DragSortListView");
    ...
    public void moveItem(int from, int to) {
        Log.i("main", "Inside moveItem of RemoveAnimator of DragSortListView");
    ...
    public void cancelDrag() {
        Log.i("main", "Inside cancelDrag of RemoveAnimator of DragSortListView");
        if (mDragState == DRAGGING) {
    ...
    private void clearPositions() {
        Log.i("main", "Inside cancelPosition of RemoveAnimator of DragSortListView");
        mSrcPos = -1;
        mFirstExpPos = -1;
        mSecondExpPos = -1;
        mFloatPos = -1;
    ...
    private void dropFloatView() {
        Log.i("main", "Inside dropFloatView of RemoveAnimator of DragSortListView");
    ...
    private void doRemoveItem() {
        ...
        Log.i("main", "Inside doRemoveItem 1 of RemoveAnimator of DragSortListView");
    ...
    private void doRemoveItem(int which) {
        // must set to avoid cancelDrag being called from the
        // DataSetObserver
        Log.i("main", "Inside doRemoveItem 2 of RemoveAnimator of DragSortListView");
        mDragState = REMOVING;
    ...
    private void adjustOnReorder() {
        Log.i("main", "Inside adjustOnRecord of RemoveAnimator of DragSortListView");
    ...
    public boolean stopDrag(boolean remove) {
        Log.i("main", "Inside stopDrag of RemoveAnimator of DragSortListView");
        mUseRemoveVelocity = false;
        return stopDrag(remove, 0);
    }

    public boolean stopDragWithVelocity(boolean remove, float velocityX) {
        Log.i("main", "Inside stopDragWithVelocity of RemoveAnimator of DragSortListView");
    ...
    public boolean onTouchEvent(MotionEvent ev) {
        Log.i("main", "Inside onTouchEvent of RemoveAnimator of DragSortListView");
    ...
    private void doActionUpOrCancel() {
        Log.i("main", "Inside doActionUpOrCancle of RemoveAnimator of DragSortListView");
    ...
    private void saveTouchCoords(MotionEvent ev) {
        Log.i("main", "Inside saveTouchCoords of RemoveAnimator of DragSortListView");
        int action = ev.getAction() & MotionEvent.ACTION_MASK;
    ...
    public boolean listViewIntercepted() {
        Log.i("main", "Inside listViewIntercepted of RemoveAnimator of DragSortListView");
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        Log.i("main", "Inside onInterceptTouchEvent of RemoveAnimator of DragSortListView");
        if (!mDragEnabled) {
    ...
    public void setDragScrollStart(float heightFraction) {
        Log.i("main", "Inside setDragScrollStart of RemoveAnimator of DragSortListView");
    ...
    public void setDragScrollStarts(float upperFrac, float lowerFrac) {
        Log.i("main", "Inside setDragScrollStarts of RemoveAnimator of DragSortListView");
    ...
    private void continueDrag(int x, int y) {
        Log.i("main", "Inside continueDrag of RemoveAnimator of DragSortListView");
    ...
    private void updateScrollStarts() {
        Log.i("main", "Inside updateScrollStarts of RemoveAnimator of DragSortListView");
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        Log.i("main", "Inside onSizeChanged of RemoveAnimator of DragSortListView");

        updateScrollStarts();
    }

    private void adjustAllItems() {
        Log.i("main", "Inside AdjustAllItems of RemoveAnimator of DragSortListView");
    ...
    private void adjustItem(int position) {
        Log.i("main", "Inside adjustItem 1 of RemoveAnimator of DragSortListView");
    ...
    private void adjustItem(int position, View v, boolean invalidChildHeight) {
        Log.i("main", "Inside adjustItem 2 of RemoveAnimator of DragSortListView");
    ...
    private int getChildHeight(int position) {
        Log.i("main", "Inside getChildHight of RemoveAnimator of DragSortListView");
    ...
    private int getChildHeight(int position, View item,
        ...
        Log.i("main", "Inside getChildHight 2 of RemoveAnimator of DragSortListView");
    ...
    private int calcItemHeight(int position, View item,
            boolean invalidChildHeight) {
        Log.i("main", "Inside CalcItemHight of RemoveAnimator of DragSortListView");
    ...
    private int calcItemHeight(int position, int childHeight) {
        Log.i("main", "Inside calcItemHight 2 of RemoveAnimator of DragSortListView");
    ...
    public void requestLayout() {
        Log.i("main", "Inside requestLayout of RemoveAnimator of DragSortListView");

        if (!mBlockLayoutRequests) {
            Log.i("main", "Inside if of requestLayout of RemoveAnimator of DragSortListView");
    ...
    private int adjustScroll(int movePos, View moveItem, int oldFirstExpPos,
            int oldSecondExpPos) {
        Log.i("main", "Inside adjustScroll of RemoveAnimator of DragSortListView");
    ...
    private void measureItem(View item) {
        Log.i("main", "Inside mesureItem of RemoveAnimator of DragSortListView");
    ...
    private void measureFloatView() {
        Log.i("main", "Inside messureFloatView of RemoveAnimator of DragSortListView");
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        Log.i("main", "Inside onMessure of RemoveAnimator of DragSortListView");
    ...
    protected void layoutChildren() {
        ...
        Log.i("main", "Inside layoutChildren of RemoveAnimator of DragSortListView");
    ...
    protected boolean onDragTouchEvent(MotionEvent ev) {
        // we are in a drag
        Log.i("main", "Inside onDragTouchEvent of RemoveAnimator of DragSortListView");
    ...
    private void invalidateFloatView() {
        Log.i("main", "Inside invalidateFloatView of RemoveAnimator of DragSortListView");
    ...
    public boolean startDrag(int position, int dragFlags, int deltaX, int deltaY) {
        Log.i("main", "Inside startDrag of RemoveAnimator of DragSortListView");
    ...
    private void doDragFloatView(boolean forceInvalidate) {
        Log.i("main", "Inside doDragFloatView 1 of RemoveAnimator of DragSortListView");
    ...
    private void doDragFloatView(int movePos, View moveItem,
        ...
        Log.i("main", "Inside doDragFloatView 2 of RemoveAnimator of DragSortListView");
    ...
    private void updateFloatView() {
        Log.i("main", "Inside updateFloatVIew of RemoveAnimator of DragSortListView");
    ...
    private void destroyFloatView() {
        Log.i("main", "Inside destroyFloatView of RemoveAnimator of DragSortListView");
    ...
    public void setDragEnabled(boolean enabled) {
        ...
        Log.i("main", "Inside setDragEnabled of RemoveAnimator of DragSortListView");
    ...
    public boolean isDragEnabled() {
        ...
        Log.i("main", "Inside isDragEnabled of RemoveAnimator of DragSortListView");
    ...
    public void setDropListener(DropListener l) {
        Log.i("main", "Inside setDropListener of RemoveAnimator of DragSortListView");
    ...
    public void setRemoveListener(RemoveListener l) {
        Log.i("main", "Inside setRemoveListener of RemoveAnimator of DragSortListView");
    ...
    public void setDragSortListener(DragSortListener l) {
        Log.i("main", "Inside setDragSortListener of RemoveAnimator of DragSortListView");
    ...
    public void setDragScrollProfile(DragScrollProfile ssp) {
        Log.i("main", "Inside setDragScrollProfile of RemoveAnimator of DragSortListView");
    ...
    public void moveCheckState(int from, int to) {
        Log.i("main", "Inside moveCheckState of RemoveAnimator of DragSortListView");
    ...
    public void removeCheckState(int position) {
        Log.i("main", "Inside removeCheckState of RemoveAnimator of DragSortListView");
    ...
    private static int buildRunList(SparseBooleanArray cip, int rangeStart,
        ...
        Log.i("main", "Inside buildRunState of RemoveAnimator of DragSortListView");
    ...
    private static int rotate(int value, int offset, int lowerBound,
        ...
        Log.i("main", "Inside rotate of RemoveAnimator of DragSortListView");
    ...
    private static int findFirstSetIndex(SparseBooleanArray sba,
        ...
        Log.i("main", "Inside findFirstSetIndex of RemoveAnimator of DragSortListView");
    ...
    private static int insertionIndexForKey(SparseBooleanArray sba, int key) {
        Log.i("main", "Inside insertionIndexForKey of RemoveAnimator of DragSortListView");
    ...
    private class DragScroller implements Runnable {
        ...
        public boolean isScrolling() {
            Log.i("main", "Inside isSCrolling of DragScroller of DragSortListView");

            return mScrolling;
        }

        public int getScrollDir() {
            Log.i("main", "Inside getScrollDir of DragScroller of DragSortListView");

            return mScrolling ? scrollDir : STOP;
        }

        public DragScroller() {
            Log.i("main", "Inside constructor of DragScroller of DragSortListView");

        }

        public void startScrolling(int dir) {
            Log.i("main", "Inside startSCrolling of DragScroller of DragSortListView");
        ...
        public void stopScrolling(boolean now) {
            Log.i("main", "Inside stopSCrolling of DragScroller of DragSortListView");
        ...
        @Override
        public void run() {
            Log.i("main", "Inside run of DragScroller of DragSortListView");
    ...
    private class DragSortTracker {
        ...
        public DragSortTracker() {
            Log.i("main", "Inside constructor of DragSortTracker of DragSortListView");
        ...
        public void startTracking() {
            Log.i("main", "Inside startTracking of DragSortTracker of DragSortListView");
        ...
        public void appendState() {
            ...
            Log.i("main", "Inside appendState of DragSortTracker of DragSortListView");
        ...
        public void flush() {
            ...
            Log.i("main", "Inside flush of DragSortTracker of DragSortListView");
        ...
        public void stopTracking() {
            ...
            Log.i("main", "Inside stopTracking of DragSortTracker of DragSortListView");
