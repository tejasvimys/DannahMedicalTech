...
public abstract class ResourceDragSortCursorAdapter extends
    ...
    public ResourceDragSortCursorAdapter(Context context, int layout, Cursor c) {
        super(context, c);
        Log.i("main", "Inside Constructor of ResourceDragSortCursorAdapter");
    ...
    public ResourceDragSortCursorAdapter(Context context, int layout, Cursor c,
        ...
        Log.i("main", "Inside Constructor 2 of ResourceDragSortCursorAdapter");
    ...
    public ResourceDragSortCursorAdapter(Context context, int layout, Cursor c,
        ...
        Log.i("main", "Inside Constructor 3 of ResourceDragSortCursorAdapter");
    ...
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        Log.i("main", "Inside newView of ResourceDragSortCursorAdapter");
    ...
    public View newDropDownView(Context context, Cursor cursor, ViewGroup parent) {
        Log.i("main", "Inside newDropDownView of ResourceDragSortCursorAdapter");
    ...
    public void setViewResource(int layout) {
        Log.i("main", "Inside setViewResource of ResourceDragSortCursorAdapter");
    ...
    public void setDropDownViewResource(int dropDownLayout) {
        Log.i("main", "Inside setDropDownViewResource of ResourceDragSortCursorAdapter");
