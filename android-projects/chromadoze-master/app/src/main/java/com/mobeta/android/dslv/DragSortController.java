...
public class DragSortController extends SimpleFloatViewManager implements
    ...
    public DragSortController(DragSortListView dslv) {
        ...
        Log.i("main", "Inside default constructor of DragSortController");
    }

    public DragSortController(DragSortListView dslv, int dragHandleId,
            int dragInitMode, int removeMode) {
        this(dslv, dragHandleId, dragInitMode, removeMode, 0);
        Log.i("main", "Inside parameterize constructor of DragSortController");
    }

    public DragSortController(DragSortListView dslv, int dragHandleId,
            int dragInitMode, int removeMode, int clickRemoveId) {
        this(dslv, dragHandleId, dragInitMode, removeMode, clickRemoveId, 0);
        Log.i("main", "Inside 2 parameterize constructor of DragSortController");
    }
    ...
    public DragSortController(DragSortListView dslv, int dragHandleId,
            ...
            int flingHandleId) {
        super(dslv);
        Log.i("main", "Inside 3 parameterize constructor of DragSortController");
        mDslv = dslv;
    ...
    public int getDragInitMode() {
        Log.i("main", "Inside constructor of DragSortController");
    ...
    {
        Log.i("main", "Inside setDragInitMode of DragSortController");
        mDragInitMode = mode;
    }
    ...
    {
        Log.i("main", "Inside setSortEnabled of DragSortController");
        mSortEnabled = enabled;
    }

    public boolean isSortEnabled() {
        Log.i("main", "Inside isSortEnabled of DragSortController");
        return mSortEnabled;
    }
    ...
    public void setRemoveMode(int mode) {
        ...
        Log.i("main", "Inside setRemoveMode of DragSortController");
        mRemoveMode = mode;
    }

    public int getRemoveMode() {
        Log.i("main", "Inside getRemoveMode of DragSortController");
        return mRemoveMode;
    }
    ...
    public void setRemoveEnabled(boolean enabled) {
        Log.i("main", "Inside setRemoveEnBLE of DragSortController");
        mRemoveEnabled = enabled;
    }

    public boolean isRemoveEnabled() {
        Log.i("main", "Inside isRemoveEnabled of DragSortController");
    ...
    public void setDragHandleId(int id) {
        Log.i("main", "Inside setDragHandledId of DragSortController");
        mDragHandleId = id;
    }
    ...
    public void setFlingHandleId(int id) {
        Log.i("main", "Inside setFlingHandledId of DragSortController");
        mFlingHandleId = id;
    }
    ...
    public void setClickRemoveId(int id) {
        Log.i("main", "Inside setClickRemoved of DragSortController");
        mClickRemoveId = id;
    }
    ...
    public boolean startDrag(int position, int deltaX, int deltaY) {
        Log.i("main", "Inside startDrag of DragSortController");
        int dragFlags = 0;
    ...
    public boolean onTouch(View v, MotionEvent ev) {
        Log.i("main", "Inside onTouch of DragSortController");
    ...
    public void onDragFloatView(View floatView, Point position, Point touch) {
        Log.i("main", "Inside onDragFloatView of DragSortController");
        if (mRemoveEnabled && mIsRemoving) {
    ...
    public int startDragPosition(MotionEvent ev) {
        Log.i("main", "Inside startDragPosition of DragSortController");
        return dragHandleHitPosition(ev);
    }

    public int startFlingPosition(MotionEvent ev) {
        Log.i("main", "Inside startFlingPosition of DragSortController");
    ...
    public int dragHandleHitPosition(MotionEvent ev) {
        Log.i("main", "Inside dragHandleHitPosition of DragSortController");
        return viewIdHitPosition(ev, mDragHandleId);
    }

    public int flingHandleHitPosition(MotionEvent ev) {
        Log.i("main", "Inside flingHandleHitPosition of DragSortController");
        return viewIdHitPosition(ev, mFlingHandleId);
    }

    public int viewIdHitPosition(MotionEvent ev, int id) {
        Log.i("main", "Inside viewIdHitPosition of DragSortController");
    ...
    public boolean onDown(MotionEvent ev) {
        Log.i("main", "Inside onDown of DragSortController");
    ...
    public boolean onScroll(MotionEvent e1, MotionEvent e2, float distanceX,
            float distanceY) {
        Log.i("main", "Inside onScroll of DragSortController");
    ...
    public void onLongPress(MotionEvent e) {
        Log.i("main", "Inside onLongPress of DragSortController");
    ...
    public final boolean onFling(MotionEvent e1, MotionEvent e2,
        ...
        Log.i("main", "Inside onFling of DragSortController");
        return false;
    }
    ...
    public boolean onSingleTapUp(MotionEvent ev) {
        Log.i("main", "Inside onSingleTapUp of DragSortController");
        if (mRemoveEnabled && mRemoveMode == CLICK_REMOVE) {
    ...
    public void onShowPress(MotionEvent ev) {
        // do nothing
        Log.i("main", "Inside onShowPress of DragSortController");
    }
    ...
    private GestureDetector.OnGestureListener mFlingRemoveListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public final boolean onFling(MotionEvent e1, MotionEvent e2,
            ...
            Log.i("main", "Inside simpleonGestureListener of DragSortController");
            if (mRemoveEnabled && mIsRemoving) {
